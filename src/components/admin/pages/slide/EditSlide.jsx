...
import { updateSlide, getOneSlide } from "../../../../utils/hepperApi";
...
const EditSlide = () => {
    ...
    useEffect(() => {
        getOneSlide(id).then((res) => {
            setSlideName(res.data.message.slide_name);
            setSlideDesc(res.data.message.slide_desc);
            setSlideImage(`${serverPublic}images/slide/${res.data.message.slide_image}`);
            setSlideStatus(res.data.message.slide_status);
            setOldImage(res.data.message.slide_image);
        });
    }, []);
    ...
    const handleSubmit = (e) => {
        ...
        updateSlide(formData).then((res) => {
            if (res.data.success === true) {
                ...
                setAlertBox({
                    type: "error",
                    message: "Sửa Slide không thành công"
                });
                setTimeout(() => { setAlertBox("") }, 1500);
            }
        });
    ...
    return (
        <div className="w-full py-2">
            ...
            >
                ...
                <h4 className="text-textColor text-xl font-semibold">Sửa Slide</h4>
